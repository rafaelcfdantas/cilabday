...
Slide 3 of the Slideshow — interactive balloon-popping minigame that reveals a hidden English paragraph. Hint phase, 3×3 balloon grid with Lottie colors, random pop SFX, pin cursor, and Next CTA to Slide 4.
